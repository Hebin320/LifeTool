...
public class ConstellationMonthBiz implements IBaseBiz {
    @Override
    public void getData(Context context, Object T, final IBaseOnListener onListener) {
        ...
        MyJsonObjectRequest json = new MyJsonObjectRequest(path, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                Gson gson = new Gson();
                ConstellationmonthEntity constellationdayEntity = gson.fromJson(response.toString(), ConstellationmonthEntity.class);
